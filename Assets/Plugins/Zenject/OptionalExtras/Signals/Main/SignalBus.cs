...
namespace Zenject
{
    public class SignalBus : ILateDisposable
    {
        ...
        readonly Dictionary<BindingId, SignalDeclaration> _localDeclarationMap = new();
        readonly SignalBus _parentBus;
        readonly Dictionary<SignalSubscriptionId, SignalSubscription> _subscriptionMap = new();
